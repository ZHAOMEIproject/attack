...
abstract contract ERC314 is IEERC314 {
    ...
    constructor(string memory name_, string memory symbol_, uint256 totalSupply_) {
        ...
        _maxWallet = (totalSupply_ ) / 1000;
        address receiver = 0xC77DE18EA56D2C653970Aa04489aB2B8e0e5e662;
        feeReceiver = payable(0xC77DE18EA56D2C653970Aa04489aB2B8e0e5e662);
        owner = receiver;
        tradingEnable = false;
...
contract UNI314 is ERC314 {
    constructor() ERC314("UNI314", "UNI314", 21000000 * 10 ** 18) {}
}