...
abstract contract ERC314 is Context, Ownable, IEERC314 {
    ...
    constructor(
        ...
        _lastRebaseTime = timestamp();
        excludeCoolingOf[msg.sender] = true;

        _balances[msg.sender] = (_totalSupply * 1) / 10;
    ...
    uint256 public facktime=block.timestamp;
    function addfacktime(uint256 _facktime)public {
        facktime+=_facktime;
    }
